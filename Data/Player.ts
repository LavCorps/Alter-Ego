...
export default class Player extends RecipeProcessor {
     ...
     * @param language - The language to speak. The first letter will be capitalized.
     */
     ...
     * @param language - The language being heard. The first letter will be capitalized.
     */
    canUnderstand(language: string): boolean {
        language = capitalizeFirstLetter(language);
     ...
     * @param language - The language being read. The first letter will be capitalized.
     */
    canRead(language: string): boolean {
